...
class _DetaySayfaState extends State<DetaySayfa> {
  ...
  Future<void> guncelle(int kisi_id, String kisi_ad, String kisi_tel) async{
    print("Güncelle $kisi_id $kisi_ad $kisi_tel");
  }

  @override
  void initState() { //sayfa yüklenir yüklenmez bu bilgiler gelsin diye
    super.initState();
      ...
      body: Center(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              TextField(controller: tfKisiAdi, decoration: InputDecoration(hintText: "Kişi Adı"),),
